...
(Discriminator, Cost, LocationId, StatusId, Author, DeweyIndex, ISBN, Title, [Year], Director, ImgUrl, NumberOfCopies) VALUES
...
INSERT INTO BranchHours (BranchId, CloseTime, [DaysOfWeek], OpenTime) VALUES 
(1, 14, 1, 7),
(1, 18, 2, 7),
(1, 18, 3, 7),
(1, 18, 4, 7),
