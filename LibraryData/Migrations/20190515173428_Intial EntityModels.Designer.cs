...
namespace LibraryData.Migrations
{
    ...
    [Migration("20190515173428_Intial EntityModels")]
    partial class IntialEntityModels
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("LibraryData.Models.Checkout", b =>
                {
                    ...
                    b.Property<int>("LibraryCheckoutAssetId");

                    b.Property<int?>("LibraryCheckoutCardId");
                    ...
                    b.HasIndex("LibraryCheckoutAssetId");

                    b.HasIndex("LibraryCheckoutCardId");

                    b.ToTable("Checkouts");
                });

            modelBuilder.Entity("LibraryData.Models.CheckoutsHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LibraryData.Models.Hold", b =>
                {
                    ...
                    b.Property<int?>("LibraryHoldAssetId");

                    b.Property<int?>("LibraryHoldCardId");

                    b.HasKey("Id");

                    b.HasIndex("LibraryHoldAssetId");

                    b.HasIndex("LibraryHoldCardId");
            ...
            modelBuilder.Entity("LibraryData.Models.Checkout", b =>
                {
                    b.HasOne("LibraryData.Models.LibraryAsset", "LibraryCheckoutAsset")
                        .WithMany()
                        .HasForeignKey("LibraryCheckoutAssetId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LibraryData.Models.LibraryCard", "LibraryCheckoutCard")
                        .WithMany("Checkouts")
                        .HasForeignKey("LibraryCheckoutCardId");
                });
            ...
            modelBuilder.Entity("LibraryData.Models.Hold", b =>
                {
                    b.HasOne("LibraryData.Models.LibraryAsset", "LibraryHoldAsset")
                        .WithMany()
                        .HasForeignKey("LibraryHoldAssetId");

                    b.HasOne("LibraryData.Models.LibraryCard", "LibraryHoldCard")
                        .WithMany()
                        .HasForeignKey("LibraryHoldCardId");
                });
